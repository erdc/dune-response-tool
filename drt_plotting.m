...
%     text([x0+1], [scenario.grids.morphometrics.dhigh+0.25], 'Dune Crest', 'FontWeight', 'bold', 'Color', 'k')
%     text([x0+1], [scenario.grids.morphometrics.dtoe+0.25], 'Dune Toe', 'FontWeight', 'bold', 'Color', 'k')
%     text([x0+2], [scenario.grids.morphometrics.dtoe-0.5], tex, 'FontWeight', 'bold', 'Color', col)
% 
